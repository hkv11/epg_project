...
ge_df     = pd.read_csv("results/depmap_GE_differential.csv")
datasets  = load_all()
...
def draw_box(ax, gene_name, q_val, title):
    plot_df = depmap_ge[["condition", "AM_class_stringent", gene_name]].dropna()
...
plt.close()
print("Saved: results/plots/depmap_boxplot_GE.png")