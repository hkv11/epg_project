...
df = pd.read_csv("results/depmap_GE_differential.csv")
...
ax.set_title("DepMap — Differential Gene Expression (ADRN vs MES)",
...
plt.tight_layout()
plt.savefig("results/plots/depmap_volcano_GE.png", dpi=300, bbox_inches="tight")
plt.close()
print("Saved: results/plots/depmap_volcano_GE.png")